...
// #[test]
// fn test_p2ms_3of3_max_pubkeys() {
//     // Test case for 3-of-3 multisig with maximum allowed public keys (20)
//     let prevout_pk_script_3of3 =
...
//     let raw_transaction = hex_to_bytecode(@raw_transaction_hex);
//     let transaction = EngineInternalTransactionTrait::deserialize(raw_transaction);
//     let utxo_hints = array![prev_out_3of3];

//     let res = validate::validate_p2ms(@transaction, 0, utxo_hints);
//     assert!(res.is_ok(), "P2MS 3-of-3 with maximum public keys validation failed");
// }
