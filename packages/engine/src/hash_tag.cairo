...
use shinigami_utils::digest::{Digest, DigestTrait};
...
pub fn tagged_hash_digest(tag: HashTag, msg: @ByteArray) -> Digest {
    ...
    sha_tag.append(@sha_tag);
    sha_tag.append(msg);
    DigestTrait::new(compute_sha256_byte_array(@sha_tag))
}
