...
export const bitcoinScriptOpcodes = [
  ...
  },
  {
    label: "OP_IF",
    description:
      "If the top stack value is not 0, the statements are executed. The value is removed.",
  },
  {
    label: "OP_NOTIF",
    description:
      "If the top stack value is 0, the statements are executed. The value is removed.",
  },
  {
    label: "OP_VERIF",
    description: "Reserved opcode. Invalid if executed.",
  ...
  },
  {
    label: "OP_RETURN",
    description:
      "Marks the end of a script. When executed, the script fails immediately.",
  },
  {
    label: "OP_TOALTSTACK",
  ...
  },
  {
    ...
    description:
      "Puts the top item on the alternate stack back onto the main stack.",
  },
  {
    label: "OP_2DROP",
  ...
  },
  {
    label: "OP_ROLL",
    description:
      "Moves an item from the stack to the top, based on a provided index.",
  },
  {
    label: "OP_ROT",
  ...
  },
  {
    label: "OP_MOD",
    description:
      "Returns the remainder after dividing the top two items (Disabled).",
  },
  {
    label: "OP_LSHIFT",
  ...
  },
  {
    ...
    description:
      "Returns 1 if the second item is less than or equal to the top item.",
  },
  {
    label: "OP_GREATERTHANOREQUAL",
    description:
      "Returns 1 if the second item is greater than or equal to the top item.",
  },
  {
    label: "OP_MIN",
  ...
  },
  {
    label: "OP_CHECKSIG",
    description:
      "Checks whether the signature is valid for the top public key and message.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Checks whether the signatures are valid for the top public keys and message.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Verifies the relative locktime before the transaction can be valid.",
  },
  {
    label: "OP_NOP4",
    description: "Does nothing.",
